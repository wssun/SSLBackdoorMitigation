...
from .cifar10_dataset import get_pretraining_cifar10, get_shadow_cifar10, get_downstream_cifar10, get_shadow_cifar10_224,get_bad_cifar10
...
def get_pretraining_dataset(args):
    if args.pretraining_dataset == 'cifar10':
        return get_pretraining_cifar10(args.data_dir,args.ratio)
    elif args.pretraining_dataset == 'stl10':
        return get_pretraining_stl10(args.data_dir,args.ratio)
    else:
        raise NotImplementedError

def get_bad_cifar10_(args):
    if args.pretraining_dataset == 'cifar10':
        return get_bad_cifar10(args.data_dir,args.ratio,args.ratio1,args.trigger_file)
    elif args.pretraining_dataset == 'stl10':
        return get_bad_cifar10(args.data_dir,args.ratio)
    else:
        raise NotImplementedError
